...
import { ArrowRight, Cloud, LineChart, TreesIcon as Plant, Sprout, Sun, Tractor } from "lucide-react"
      ...
      <main className="flex-1">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
                  Smart Farming with <span className="text-green-600 dark:text-green-400">FarmAI</span>
                </h1>
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Your AI-powered farming assistant, custom trained to answer all your agricultural queries and help you
                  grow better crops.
                </p>
              </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Farming Solutions</h2>
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8 py-8">
                <Card className="flex flex-col items-center text-center">
                  <CardHeader>
                    ...
                    <CardDescription>Expert guidance for optimal crop growth</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Get personalized recommendations for crop selection, planting schedules, and growing techniques
                ...
                <Card className="flex flex-col items-center text-center">
                  <CardHeader>
                    ...
                    <CardDescription>Identify and treat plant diseases and pests</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Upload photos of affected plants to get instant identification of diseases and pests, with organic
                ...
                <Card className="flex flex-col items-center text-center">
                  <CardHeader>
                    ...
                    <CardDescription>Data-driven market analysis for better profits</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Access real-time market prices, demand forecasts, and optimal selling times to maximize your
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 py-8">
                <div className="flex flex-col items-center space-y-2 border rounded-lg p-6">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                    Our AI is trained on agricultural data from thousands of farms across different regions and
                    climates.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center space-y-2 border rounded-lg p-6">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                    Get advice tailored to your specific location, weather patterns, and growing conditions.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center space-y-2 border rounded-lg p-6">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                    Get farming advice 24/7, even during busy planting and harvest seasons when you need it most.
                  </p>
                </div>
              </div>
            </div>
